...
#' [`GdObject`][GdObject-class] upon instantiation, unless one or more of them
...
#' for grid lines, both when `type=="g"` in [`DataTrack`][DataTrack-class]
...
#' grid lines, see [`panel.grid`][lattice::panel.grid] for details.
...
#' grid lines, both when `type=="g"` in [`DataTrack`][DataTrack-class] objects
...
#' when `type=="g"` in [`DataTrack`][DataTrack-class] objects and when the
...
#' [`GeneRegionTrack`][GeneRegionTrack-class] and
#' [`AnnotationTrack`][AnnotationTrack-class] classes as well as [`grouping`]
#' for details.
