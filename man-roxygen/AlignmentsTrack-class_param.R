...
#' @param stackRanges A [`GRanges`][GenomicRanges::GRanges-class] object with
...
#' @param sequences A [`DNAStringSet`][Biostrings::DNAStringSet-class] object
...
#' @param flag A named integer vector of length 2, as produced by
...
#' @param groupid A factor (or vector that can be coerced into one) defining
...
#' effectively an alternative to the CIGAR encoding, and it removes the
#' dependency on a reference sequence to figure out read mismatches. Needs to
#' be of equal length as the provided genomic coordinates, or of length 1.
#' Currently not used.
#' @param seqs A [`DNAStringSet`][Biostrings::DNAStringSet-class] object of read
#' sequences.
