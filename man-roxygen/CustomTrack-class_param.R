...
#' @param minBase Numeric scalar, the start coordinate of the plotting range.
#' @param maxBase Numeric scalar, the end coordinate of the plotting range.
...
#' @param object Object of class [`CustomTrack`][CustomTrack-class].
