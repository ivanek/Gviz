...
#' \describe{
#'
#' \item{A `GRanges` object:}{ essentially all the necessary information
...
#'
#' \item{An [IRanges][IRanges::IRanges-class] object:}{ this is very similar to
#' the above case, except that the numeric data part now always has to be
#' provided in the separate `data` argument. Also the chromosome information
#' must be provided in the `chromosome` argument, because neither of the two
