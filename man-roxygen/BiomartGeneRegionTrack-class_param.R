...
#' Biomart query.
#' @param range A `GRanges` object with the genomic coordinates of the gene
#' model items.
...
#' access to the EBI Biomart webservice. As default the appropriate Ensembl data
...
#' where `x` may be any possible string. The user has to make sure that
...
#' source is possible, the `biomart` argument needs to be provided by the
#' user.
