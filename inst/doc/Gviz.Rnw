...
types <- data.frame(Value=c("p", "l", "b", "a", "s", "S", "g", "r", "h", "smooth", "histogram", "mountain", "polygon", "boxplot", "gradient", "heatmap"),
...
For the heatmap-type plotting type we arrange all the data in a
...
ignored. We can examplify this in the next code chunk. Note that the
